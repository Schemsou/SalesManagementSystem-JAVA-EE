...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-light" style="">
      <div class="container-fluid" style="height: 70px; padding-top: 10px">
        ...
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="ClientsList.jsp" class="navbuttons"> Clients List </a>
          </li>
          <li>
            <a href="ArticlesList.jsp" class="navbuttons">Articles List</a>
          </li>
    ...
    <sql:setDataSource
      ...
      password="admin"
    />
    <sql:query var="bill" dataSource="${db}"> select * from bill </sql:query>
    ...
    <table class="table table-striped">
      ...
      <c:forEach items="${bill.rows}" var="i">
        <tr class="odd:bg-white even:bg-slate-50">
          ...
          <td>
            <a href="DeleteBill.jsp?billnumber=${i.billnumber}">Delete </a>
          </td>
        </tr>
      </c:forEach>
    </table>
